...
app.controller("AuthorController", ["${dollar}scope", "${dollar}window", "${dollar}aside", "PlaceholderTextService", 
"${dollar}log", "AuthorRestService", "AuthorRestSearchService", "AuthorRestIndexService", function(scope, b, c, d, log, authorRestService, authorRestSearchService, authorRestIndexService) {
scope.settings = {
singular: "Item",
plural: "Items",
cmd: "Add"
